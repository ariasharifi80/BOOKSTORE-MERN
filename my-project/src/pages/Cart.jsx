    ...
    <div className="max-padd-container py-16 pt-28">
      <div className="flex flex-col xl:flex-row gap-20 xl:gap-28">
        ...
        <div className="flex flex-[2] flex-col gap-3">
          <Title title1={"Cart"} title2={""} titleStyles={"pb-5"} />
          ...
          {books.map((book) => {
            ...
            if (quantity > 0) {
              return (
                <div
                  key={book._id}
                  className="grid grid-cols-[6fr_1fr_2fr] items-center font-medium bg-primary p-2 rounded-lg"
                >
                  <div className="flex items-center md:gap-6 gap-3">
                    ...
                    <div>
                      ...
                      <div className="flexBetween mt-2">
                        <div className="flex item-center ring-1 ring-slate-900/5 p-0.5 rounded-full overflow-hidden bg-white">
                          <button
                            onClick={() =>
                          ...
                          <p className="px-2 pt-1">{quantity}</p>
                          <button
                            onClick={() =>
                              updateQuantity(book._id, quantity + 1)
                            }
